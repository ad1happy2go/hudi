...
// 0.13.1 defines hoodie.base.path on HoodieWriteConfig (moved to HoodieCommonConfig in 0.15.x);
// the key string is identical, so configs stay interchangeable across both writer versions.
