...
public class TestComplexAvroKeyGenerator {
  ...
  @CsvSource(value = {
      ...
      "false,true,8,", "true,false,8,", "true,true,8,", "false,true,9,", "true,false,9,", "true,true,9,", // property present (stamped by the 8 -> 9 upgrade): it is authoritative at every version
      "false,true,9,VALUE_ONLY", "true,false,9,VALUE_ONLY", "true,true,9,FIELD_PREFIXED", "true,true,8,FIELD_PREFIXED", "true,false,8,VALUE_ONLY"})
