...
public class ComplexKeyGenerator extends BuiltinKeyGenerator {
  ...
  public String getRecordKey(Row row) {
    ...
    return combineCompositeRecordKey(encodeSingleKeyFieldName, rowAccessor.getRecordKeyParts(row));
  }

  @Override
  public UTF8String getRecordKey(InternalRow internalRow, StructType schema) {
    tryInitRowAccessor(schema);
    return combineCompositeRecordKeyUnsafe(encodeSingleKeyFieldName, rowAccessor.getRecordKeyParts(internalRow));
  }
